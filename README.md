# sanity-gatsby-portfolio-meetup
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/xio7r8wn/settings/api) and create a token with read rights.
